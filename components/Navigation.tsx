      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a
              href="#contact"
              className="px-6 py-2.5 bg-slate-800 text-white rounded-lg hover:bg-amber-600 transition-all duration-300 transform hover:scale-105 hover:shadow-lg font-medium"
            >
              Schedule Viewing
            </a>
          </div>
          ...
          >
            <div className="w-6 h-5 flex flex-col justify-between">
              <span
                className={`w-full h-0.5 bg-slate-800 transition-all duration-300 ${
        ...
        >
          <div className="flex flex-col space-y-4 pt-4 border-t border-gray-200">
            ...
            <a
              href="#contact"
              onClick={() => setMobileMenuOpen(false)}
              className="px-6 py-3 bg-slate-800 text-white rounded-lg hover:bg-amber-600 transition-all duration-300 text-center font-medium"
            >
              Schedule Viewing
            </a>
          </div>
